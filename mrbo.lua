...
-- 1. KHỞI TẠO BIẾN HỆ THỐNG mr_bo ĐỂ TẢI THƯ VIỆN GIAO DIỆN CHUẨN
local mr_bo = loadstring(game:HttpGet("https://github.com"))()
...
-- ====================================================================
-- TAB 9: GIAO DIỆN NGƯỜI DÙNG CÀI ĐẶT (SETTINGS UI) - CẬP NHẬT MỚI THEO ẢNH
-- ====================================================================
